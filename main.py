...
class Contacts(db.Model):
    ...
    mes = db.Column(db.String(500), unique=True, nullable=False)
...
class Posts(db.Model):
    ...
    content = db.Column(db.String(50000), unique=True, nullable=False)
    date = db.Column(db.String(15), unique=True, nullable=True)
    tagline = db.Column(db.String(15), unique=True, nullable=False)
